<?php /* Smarty version Smarty-3.1.7, created on 2015-07-16 16:39:07
         compiled from "C:\wamp\www\vtigercrm\vtigercrm6.3\includes\runtime/../../layouts/vlayout\modules\Users\ListViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:309855a7ac44a1cb99-46008772%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '444a5536934fdddef77f4c5d6ca35d7b4e115c14' => 
    array (
      0 => 'C:\\wamp\\www\\vtigercrm\\vtigercrm6.3\\includes\\runtime/../../layouts/vlayout\\modules\\Users\\ListViewHeader.tpl',
      1 => 1437064742,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '309855a7ac44a1cb99-46008772',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_55a7ac44d260c',
  'variables' => 
  array (
    'MODULE' => 0,
    'QUALIFIED_MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_55a7ac44d260c')) {function content_55a7ac44d260c($_smarty_tpl) {?>
...
</h3></div><hr><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Users'){?><div><?php echo vtranslate('User Desc',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</div><?php }?><div class="row-fluid"><span class="span4 btn-toolbar"><span class="btn-group listViewMassActions"><?php if (count($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEW'])>0){?><button class="btn dropdown-toggle" data-toggle="dropdown"><strong><?php echo vtranslate('LBL_ACTIONS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
