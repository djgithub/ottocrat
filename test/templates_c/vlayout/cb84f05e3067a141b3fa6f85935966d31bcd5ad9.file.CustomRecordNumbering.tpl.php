<?php /* Smarty version Smarty-3.1.7, created on 2015-07-16 17:22:33
         compiled from "C:\wamp\www\vtigercrm\vtigercrm6.3\includes\runtime/../../layouts/vlayout\modules\Settings\Vtiger\CustomRecordNumbering.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2256655a7b342b2ca91-75775047%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb84f05e3067a141b3fa6f85935966d31bcd5ad9' => 
    array (
      0 => 'C:\\wamp\\www\\vtigercrm\\vtigercrm6.3\\includes\\runtime/../../layouts/vlayout\\modules\\Settings\\Vtiger\\CustomRecordNumbering.tpl',
      1 => 1437067349,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2256655a7b342b2ca91-75775047',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_55a7b342e5802',
  'variables' => 
  array (
    'QUALIFIED_MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_55a7b342e5802')) {function content_55a7b342e5802($_smarty_tpl) {?>
...
</h3></div></span></div><hr><div>The Customize Record Numbering feature helps classifying the records by unique numbers. Once the auto number field is added to CRM module, the number gets added sequentially to the new records.</div><br><div class="row-fluid"><div class="span12"><table id="customRecordNumbering" class="table table-bordered"><?php $_smarty_tpl->tpl_vars['DEFAULT_MODULE_DATA'] = new Smarty_variable($_smarty_tpl->tpl_vars['DEFAULT_MODULE_MODEL']->value->getModuleCustomNumberingData(), null, 0);?><?php $_smarty_tpl->tpl_vars['DEFAULT_MODULE_NAME'] = new Smarty_variable($_smarty_tpl->tpl_vars['DEFAULT_MODULE_MODEL']->value->getName(), null, 0);?><?php $_smarty_tpl->tpl_vars['WIDTHTYPE'] = new Smarty_variable($_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('rowheight'), null, 0);?><thead><tr><th width="30%" class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
