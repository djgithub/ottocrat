...
// vtiger_account query goes for ecery single vtiger_account row
	...
	*/
	function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
		...
		$userNameSql = getSqlForNameInDisplayFormat(array('first_name'=>
							'vtiger_users.first_name', 'last_name' => 'vtiger_users.last_name'), 'Users');
			$query = "select case when (vtiger_users.user_name not like '') then $userNameSql else vtiger_groups.groupname end as user_name,vtiger_emaildetails.from_email as from_email,replace(replace(vtiger_emaildetails.to_email,'\"]',''),'[\"','') as saved_toid," .
				" vtiger_activity.activityid, vtiger_activity.subject, vtiger_activity.activitytype, vtiger_crmentity.modifiedtime," .
				" vtiger_crmentity.crmid, vtiger_crmentity.smownerid, vtiger_activity.date_start, vtiger_activity.time_start, vtiger_seactivityrel.crmid as parent_id,concat(date_start,time_start) as dateTime " .
				" from vtiger_activity, vtiger_seactivityrel, vtiger_contactdetails, vtiger_users,vtiger_emaildetails, vtiger_crmentity " .
				" left join vtiger_groups on vtiger_groups.groupid=vtiger_crmentity.smownerid" .
				...
				" and vtiger_crmentity.crmid = vtiger_activity.activityid and vtiger_activity.activityid=vtiger_emaildetails.emailid  and vtiger_contactdetails.contactid = ".$id." and" .
