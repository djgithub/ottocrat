...
<div class="container-fluid">
    <form id="EditView" method="POST">
        ...
        <hr>
        <div>The Customize Record Numbering feature helps classifying the records by unique numbers. Once the auto number field is added to CRM module, the number gets added sequentially to the new records.</div>
        <br>
        <div class="row-fluid">
            <div class="span12">
