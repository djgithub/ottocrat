...
$languageStrings = array(
	...
	'LBL_COMMUNICATION_TEMPLATES' => 'Company Information',#theleadrec changes-5
	...
	'LBL_PICKLIST_EDITOR_TEXT' => 'As the name itself says, picklist is a dropdown field with list of options available, within which, only one option can be selected.For instance, Lead status in Leads module. Picklist Editor can be used to customize the picklist values in different modules.Select a role before performing global actions such as add, edit and, delete; as the picklist values vary across roles.',//theleadrec changes-5
