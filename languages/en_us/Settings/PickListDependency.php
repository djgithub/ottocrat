...
$languageStrings = array(
	...
	'LBL_PICKLIST_DEPENDENCY_TEXT' => 'Picklist dependency feature enable the administrator to configure the values of a picklist field (target field) to be shown based on the value chosen for another picklist field (source field).',//theleadrec changes-5
